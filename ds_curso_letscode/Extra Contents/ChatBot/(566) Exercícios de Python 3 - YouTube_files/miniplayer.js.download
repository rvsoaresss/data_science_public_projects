...
fill:"#fff","fill-rule":"nonzero"}}]}]}]};var e="Abrir p\u00e1gina do v\u00eddeo";g.R(a.O().experiments,"kevlar_miniplayer_expand_top")&&(c="ytp-miniplayer-button-top-left",d=g.Y?{F:"div",X:["ytp-icon","ytp-icon-expand-miniplayer"]}:{F:"svg",N:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},L:[{F:"g",N:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},L:[{F:"g",N:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},L:[{F:"path",
N:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Expandir");g.W.call(this,{F:"button",X:["ytp-miniplayer-expand-watch-page-button","ytp-button",c],N:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button"},L:[d]});this.w=a;this.ga("click",this.A,this);this.updateValue("title",
g.rN(a,e,"i"));g.xi(this,g.NN(b.Va(),this.element))},R5=function(a){g.Ju.call(this,{F:"div",
I:"ytp-miniplayer-ui"});this.player=a;this.J=!1;this.H=this.C=this.w=void 0;this.M(a,"minimized",this.KF);this.M(a,"onStateChange",this.IM)},S5=function(a){g.kQ.call(this,a);
...
g.h.show=function(){this.w=new g.Vm(this.JF,null,this);this.w.start();if(!this.J){this.D=new g.GR(this.player,this);g.H(this,this.D);g.YK(this.player,this.D.element,4);this.D.C=.6;this.T=new g.EQ(this.player);g.H(this,this.T);this.A=new g.W({F:"div",I:"ytp-miniplayer-scrim"});g.H(this,this.A);this.A.o(this.element);this.M(this.A.element,"click",this.Oy);var a=new g.W({F:"button",X:["ytp-miniplayer-close-button","ytp-button"],N:{"aria-label":"Fechar"},L:[g.IM()]});g.H(this,a);a.o(this.A.element);this.M(a.element,
"click",this.jx);a=new Q5(this.player,this);g.H(this,a);a.o(this.A.element);this.B=new g.W({F:"div",I:"ytp-miniplayer-controls"});g.H(this,this.B);this.B.o(this.A.element);this.M(this.B.element,"click",this.Oy);var b=new g.W({F:"div",I:"ytp-miniplayer-button-container"});g.H(this,b);b.o(this.B.element);a=new g.W({F:"div",I:"ytp-miniplayer-play-button-container"});g.H(this,a);a.o(this.B.element);var c=new g.W({F:"div",I:"ytp-miniplayer-button-container"});g.H(this,c);c.o(this.B.element);this.P=new g.tO(this.player,
...
N:{"aria-label":"Fechar"},L:[g.IM()]});g.H(this,a);a.o(this.G.element);this.M(a.element,"click",this.jx);a=new g.W({F:"button",X:["ytp-miniplayer-replay-button","ytp-button"],N:{"aria-label":"Fechar"},L:[g.VM()]});g.H(this,a);a.o(this.G.element);this.M(a.element,"click",this.BK);this.M(this.player,"presentingplayerstatechange",this.LF);this.M(this.player,"appresize",this.Vq);this.M(this.player,"fullscreentoggled",this.Vq);this.Vq();this.J=!0}0!=this.player.getPlayerState()&&g.Ju.prototype.show.call(this);
...
g.h.jx=function(){this.player.stopVideo();this.player.la("onCloseMiniplayer")};
g.h.BK=function(){this.player.playVideo()};
g.h.Oy=function(a){if(a.target==this.A.element||a.target==this.B.element)g.R(this.player.O().experiments,"kevlar_miniplayer_play_pause_on_scrim")?g.Qt(g.FK(this.player))?this.player.pauseVideo():this.player.playVideo():this.player.la("onExpandMiniplayer")};
g.h.KF=function(){g.L(this.player.getRootNode(),"ytp-player-minimized",this.player.app.H.o)};
g.h.JF=function(){g.EO(this.C);this.H.w();this.w&&this.w.start()};
g.h.LF=function(a){g.T(a.state,32)&&this.D.hide()};
g.h.Vq=function(){var a=this.C,b=g.GK(this.player).getPlayerSize().width;a.Aa=0;a.C=b;a.G=!1;g.GO(a)};
g.h.IM=function(a){this.player.app.H.o&&(0==a?this.hide():this.show())};
...
g.h.Uq=function(){return new g.Yf(0,0,0,0)};
